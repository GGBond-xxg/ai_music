      ...
      try {
        await db.transaction((txn) async {
          ...
          await txn.insert(
            'records',
            Record(
                    trackId: 'local:track:sample1', // Matches Track 1
                    ...
                    recordedAt: DateTime.now()
                        ...
                        .millisecondsSinceEpoch,
                    contextUri: 'local:playlist:testplaylist',
          ...
          await txn.insert(
            'records',
            Record(
              trackId: 'local:track:sample2', // Matches Track 2
