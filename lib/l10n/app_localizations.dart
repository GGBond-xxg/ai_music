...
abstract class AppLocalizations {
  ...
  /// Status text showing the logged in Music username
  ///
  /// In en, this message translates to:
  /// **'Music: {username}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'音乐源配置无效，请检查服务器地址、账号、密码或 API Key。'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Set Music Client ID and Secret'**
  ...
  /// Error message when failing to open Music
  ///
  /// In en, this message translates to:
  /// **'Failed to open Music: {error}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'I rated {albumName} by {artist} {score} on Music, rated {rated}/{total} songs.'**
