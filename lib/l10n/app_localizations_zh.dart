...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get authorizeSpotifyButton => '授权 音乐';

  @override
  String get logoutSpotifyButton => '登出 音乐';
  ...
  @override
  String get loginSuccess => '已使用 音乐 登录';
  ...
  @override
  String get sonosDeviceRestriction => '请使用 音乐 或 Sonos 应用控制此设备';
  ...
  @override
  String get logoutSuccess => '已登出 音乐';
  ...
  @override
  String get spotifyApiSubtitle => '设置 音乐 客户端 ID 和 Secret';
  ...
  @override
  String get credentialsSaved => '音乐 凭证已保存';
  ...
  @override
  String get cannotCreateSpotifyLink => '无法创建 音乐 链接';

  @override
  String get cannotOpenSpotify => '无法打开 音乐';

  @override
  String failedToOpenSpotify(String error) {
    return '打开 音乐 失败: $error';
  }
  ...
  String shareAlbumMessage(
    ...
    return '我在 音乐 给《$albumName》（$artist）打出了 $score 分，已评分 $rated/$total 首歌曲。';
  }
  ...
  @override
  String get authFailureExceeded => '授权失败次数已达上限，请检查 音乐 Client ID 是否正确配置';
...
class AppLocalizationsZhTw extends AppLocalizationsZh {
  ...
  @override
  String get authorizeSpotifyButton => '授權 音樂';

  @override
  String get logoutSpotifyButton => '登出 音樂';
  ...
  @override
  String get loginSuccess => '已使用 音樂 登入';
  ...
  @override
  String get sonosDeviceRestriction => '請使用 音樂 或 Sonos 應用程式控制此裝置';
  ...
  @override
  String get logoutSuccess => '已登出 音樂';

  @override
  String get operationFailed => '操作失敗';

  @override
  String get invalidCredentialsError => '音樂源配置無效，請檢查伺服器位址、帳號、密碼或 API Key。';
  ...
  @override
  String get spotifyApiTitle => '音樂源';

  @override
  String get spotifyApiSubtitle => '設定 音樂 用戶端 ID 和密鑰';
  ...
  @override
  String get spotifyCredentialsDialogTitle => '音樂源';
  ...
  @override
  String get credentialsSaved => '音樂 憑證已儲存';
  ...
  @override
  String get cannotCreateSpotifyLink => '無法建立 音樂 連結';

  @override
  String get cannotOpenSpotify => '無法開啟 音樂';

  @override
  String failedToOpenSpotify(String error) {
    return '開啟 音樂 失敗: $error';
  }
  ...
  String shareAlbumMessage(
      String albumName, String artist, String score, int rated, int total) {
    return '我在 音樂 給《$albumName》（$artist）打出了 $score 分，已評分 $rated/$total 首歌曲。';
  }
  ...
  @override
  String get authFailureExceeded => '授權失敗次數已達上限，請檢查 音樂 Client ID 是否正確配置';
