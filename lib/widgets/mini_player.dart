...
class _MiniPlayerState extends State<MiniPlayer> {
  ...
  void _ensureCoverSeed(
    ...
    _seedKey = key;
    final cached = CoverPaletteCache.instance.cachedSeedForTrack(track, brightness);
    if (cached != null) {
      _coverSeed = cached;
    } else {
      _coverSeed = fallbackColor;
    }
      ...
      children: [
        ...
        Positioned.fill(
          child: TweenAnimationBuilder<double>(
            tween: Tween<double>(begin: safeProgress, end: safeProgress),
